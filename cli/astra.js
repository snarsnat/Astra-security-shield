...
async function cmdAdd(targetPath) {
  ...
  console.log(`  1. Go to ${C.bold}https://astra-shield-site.vercel.app/dashboard${C.reset}`);
  console.log(`  2. Click ${C.bold}+ Add app${C.reset} and paste the token above`);
  console.log(`  3. Your app is now connected to Astra Shield`);
  console.log();
